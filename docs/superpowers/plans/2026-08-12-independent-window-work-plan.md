...
- [x] **3편 ② C 1회 개봉 완료(2026-08-14, main 7a28efb — C 구간 소모됨)**:
  ▸ **Arm-53: 기각** — 방향 미재현(armA 0.9681 vs arm53 0.9486, CAGR −0.45pp,
    MDD −4.34pp). A+B +11.3pp 개선이 독립 구간에서 소멸·역전(관찰 구간 과적합
    검출). production 반영 금지 유지. 개봉 직전 entry_rate 교차 오염 수리(f5aab89).
