...
**머지 판정 추가 기록(전문가, 2026-09-09)**: 성과 변동(1.0185→1.1676)은 governance 3-3 관측이며 근거가
아니다 — 변경 근거는 TTLC Ch.9. P1 제거 변형(1.2015, 추가 7건 전부 P1 미충족)은 **holdout 사전등록 시 arm
후보로 등록**한다. 현 버전(P1 적용) 조정 금지(3-4).
