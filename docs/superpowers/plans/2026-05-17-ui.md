...
- `~/downloads/analyze_chart_v3.md` 와 `calculate_entry_params_v2_0.md` 존재 (Task 1 에서 prompts/ 로 복사)
...
```bash
mkdir -p ~/kr-by-claude/prompts
cp ~/downloads/analyze_chart_v3.md ~/kr-by-claude/prompts/
cp ~/downloads/calculate_entry_params_v2_0.md ~/kr-by-claude/prompts/
ls ~/kr-by-claude/prompts/
```
...
```bash
mkdir -p ~/kr-by-claude/api/{routers,schemas,services}
touch ~/kr-by-claude/api/__init__.py
touch ~/kr-by-claude/api/routers/__init__.py
touch ~/kr-by-claude/api/schemas/__init__.py
touch ~/kr-by-claude/api/services/__init__.py
```
...
```bash
cat >> ~/kr-by-claude/.gitignore <<'EOF'
