...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  { term: "excluded_by_universe", meaning: "유니버스 배제 — 증권구분(security_group)이 주권·외국주권·주식예탁증권이 아니어서 '판정 대상이 아닌' 종목의 모니터링 종료 기록. disqualified('판정해서 떨어짐')와 다른 값이며 실격·강등이 아님. LLM 분류가 아니고 패턴·확신도 없음." },
  ...
  { term: "daily_delta", meaning: "평일 매일 *신규 후보만* AI 분류 — 최근 7일 안에 LLM 분류(weekend·daily_delta)된 적 없는 새 종목. weekly_classification 에 source='daily_delta' 로 행 추가." },
  { term: "신규 종목 (7일 cool-down)", meaning: "결정론 통과 + 최근 7일 안에 LLM 분류 이력 없음(실격 기록은 세지 않음 — #145). daily_delta 의 대상 조건. 같은 종목 반복 분석 방지 + ignore·실격 후 재진입 허용." },
