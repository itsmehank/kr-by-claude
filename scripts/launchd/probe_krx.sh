...
#
# KRX 접촉 = 로그인 2회(python 서브프로세스 2개 × pykrx import 부작용 각 1회)
#            + OHLCV 종목당 1~3회 + 전종목시세 1회(#94 판정 블록)
#            (_fetch_one/fetch_market_snapshot 은 차단 시 빈 DataFrame/KeyError 흡수로
#             예외 없이 반환 — 재시도 없이 각 1회로 끝난다)
#
